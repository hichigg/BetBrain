...
export default function MobileNav() {
  ...
  return (
    <>
      ...
      {/* Slide-out drawer */}
      <div
        className={`lg:hidden fixed inset-y-0 left-0 w-[80vw] max-w-72 bg-slate-900 border-r border-slate-800 z-50 transform transition-transform duration-300 ease-in-out flex flex-col ${
